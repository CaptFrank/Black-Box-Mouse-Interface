 ...
 */
#define USB_CFG_VENDOR_NAME     'C', 'a', 'r', 'l', 'e', 't', 'o', 'n', ' ', 'U', 'n', 'i', 'v', 'e', 'r', 's', 'i', 't', 'y',
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'U', 'S', 'B', ' ', 'H', 'I', 'D', ' ', 'D', 'e', 'v', 'i', 'c', 'e', 's',
#define USB_CFG_DEVICE_NAME_LEN 15
/* Same as above for the device name. If you don't want a device name, undefine
 * the macros. See the file USB-IDs-for-free.txt before you assign a name if
 * you use a shared VID/PID.
 */
#define USB_CFG_SERIAL_NUMBER   '0', 'x', '0', '1'
...
/**
 * REDEFINED in the USB_REPORT region of the code.
 * This varies with the report that is chosen.
 */
